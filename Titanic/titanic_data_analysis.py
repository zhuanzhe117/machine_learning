...
# ax1.set_xticklabels([u"not", u"sur"], rotation=0)
...
# print data_train.Survived[data_train.Sex == 'female'][data_train.Pclass != 3].value_counts().sort_index()
