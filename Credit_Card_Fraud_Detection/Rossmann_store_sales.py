...
store = pd.read_csv('D:/materials/dataset/Credit_Card_Fraud_Detection/data/store.csv')
store.head()

train_df = pd.read_csv('D:/materials/dataset/Credit_Card_Fraud_Detection/data/train.csv')
train_df.head()

test_df = pd.read_csv('D:/materials/dataset/Credit_Card_Fraud_Detection/data/test.csv')
test_df.head()
